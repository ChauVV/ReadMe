...
[![pipeline status](https://gitlab.com/pyco-group/genvita/badges/master/pipeline.svg)](https://gitlab.com/pyco-group/genvita/commits/master) [![coverage report](https://gitlab.com/pyco-group/genvita/badges/master/coverage.svg)](https://gitlab.com/pyco-group/genvita/commits/master)
...
```
$ ENV=dev yarn android
$ ENV=dev MODE=Release yarn android // Open the app in release mode
```
...
### View storybook document
#### Run storybook server
```
$ yarn storybook
$ ENV=storybook yarn start
```

#### Start the storybook in iOS/Android
```bash
yarn ios
yarn android
```
...
$ yarn icon:build
```
[Further icons instruction](src/assets/fontello/README.md)
